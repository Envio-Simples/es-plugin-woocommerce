...
require_once "class-es-plugin-woo-api.php";
require_once "class-es-plugin-woo-simples.php";
...
class Es_Plugin_Woo_main
{
    ...
    public function isw_woo_update_ticket($order_id)
    {
        ...
        if (!$ticket_code) { //Senão existe gera uma etiqueta 
            ...
            $envio = new Es_Plugin_Woo_API($token, $sandbox);
